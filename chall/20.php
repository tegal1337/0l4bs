...
if(!isset($_GET['status'])) {
  header('Location: 20.php?status=tegal1337');
}
?>
<!DOCTYPE html>
<html>
            ...
            <div class="terminal-window primary-bg" onclick="document.getElementById('dummyKeyboard').focus();">
              <div class="terminal-output" id="terminalOutput">
                <div class="terminal-line">
                  <span class="help-msg">Chall 20 — Clue : <span class="code">HTML entities, HTML input value + capitalizes all characters</span> </span>
                </div>
              </div>
...
?>
            ...
            <button style="align:right;" class="button is-link is-outlined is-small"><a href="19.php">Previous Chall</a></button>
