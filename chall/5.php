<?php
if (!isset($_COOKIE['labs-tegal1337'])) {
	setcookie('labs-tegal1337', 'labs-tegal1337', time() + (86400 * 30), "/",null,null,true);
	header("Refresh:0");
}
?>
<!DOCTYPE html>
...
if (isset($_COOKIE['labs-tegal1337'])) {
    ...
    echo "<br><span style=\"font-size:1em;\">Current value supplied by <b>labs-tegal1337</b> cookie is: </span><br>" . (string)$_COOKIE['labs-tegal1337'] . '';
